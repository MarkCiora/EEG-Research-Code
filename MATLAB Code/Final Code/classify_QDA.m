...
for j = 1:20
    ...
    accuracy(j) = test_QDA_accuracy(QDA_classifier, test_set, test_y);
end
...
for j = 1:10
    ...
    QDA_classifier = QDA(train_set, train_y);
    %QDA_classifier.P(1) = .5;
    %QDA_classifier.P(2) = .5;
    accuracy(2*j-1) = test_QDA_accuracy(QDA_classifier, test_set, test_y);
end
for j = 1:10
    b = 2*j-1;
    a = j + 1;
    ...
    %QDA_classifier.P(1) = .5;
    %QDA_classifier.P(2) = .5;
    accuracy(2*j) = test_QDA_accuracy(QDA_classifier, test_set, test_y);
end
