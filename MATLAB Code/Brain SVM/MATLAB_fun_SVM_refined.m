...
clear input
for j = 1:20
    x1 = zeros(4,width(A(j).s_o2_refined));
    x2 = zeros(4,width(A(j).d_o2_refined));
    
    x1(1,:) = A(j).s_o2_refined(1,:,1);
    x2(1,:) = A(j).d_o2_refined(1,:,1);
    
    x1(2,:) = A(j).s_o2_refined(1,:,2);
    x2(2,:) = A(j).d_o2_refined(1,:,2);
    
    x1(3,:) = A(j).s_o2_refined(1,:,3);
    x2(3,:) = A(j).d_o2_refined(1,:,3);
    
    x1(4,:) = A(j).s_o2_refined(1,:,4);
    x2(4,:) = A(j).d_o2_refined(1,:,4);
